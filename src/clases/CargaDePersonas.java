 ...
 * fecha de nacimiento. Al agregar debe anexarse (nombre, apellido, edad) a los
 * demás dados de alta, visualizados en una Label.
 *
 */
public class CargaDePersonas extends javax.swing.JFrame {
    ...
    public CargaDePersonas() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargaDePersonas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        Titulo.setText("Carga de Datos de Persona");
        ...
        if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty()) {
            ...
            try {
                if ((Integer) jSpinner3.getValue() > anioActual) {
                    ...
                    jTextArea1.append("Nombre: " + jTextField1.getText() + "\n"
                            + "Apellido: " + jTextField2.getText() + "\n"
                            + "Edad: " + (anioActual - (Integer) jSpinner3.getValue()) + "\n\n");
                    jTextField1.setText("");
                    jTextField2.setText("");
